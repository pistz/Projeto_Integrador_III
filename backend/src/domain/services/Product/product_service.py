...
class ProductService(IProductService):
    ...
    def create_product(self, product:CreateProductDTO) -> HttpResponse:
        ...
        return HttpResponse(status_code=StatusCode.CREATED.value, body={"message":"Produto criado com sucesso"})
    ...
    def update_product(self, product_id, product:UpdateProductDTO) -> HttpResponse:
        ...
        return HttpResponse(status_code=StatusCode.CREATED.value, body={"message":"Produto atualizado com sucesso"})
    ...
    def delete_product(self, product_id:int) -> HttpResponse:
        ...
        return HttpResponse(status_code=StatusCode.OK.value, body={"message":"Produto deletado com sucesso"})
