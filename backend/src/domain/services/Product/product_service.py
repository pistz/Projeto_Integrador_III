...
class ProductService(IProductService):
    ...
    def get_product_by_id(self, product_id:int) -> HttpResponse:
        ...
        return HttpResponse(status_code=200, body=product)
    ...
    def get_all_products(self) -> HttpResponse:
        ...
        return HttpResponse(status_code=200, body=products)
    ...
    def create_product(self, product:CreateProductDTO) -> HttpResponse:
        ...
        return HttpResponse(status_code=201, body={"message":"Product created successfully"})
    ...
    def update_product(self, product_id, product:UpdateProductDTO) -> HttpResponse:
        ...
        return HttpResponse(status_code=200, body={"message":"Product updated successfully"})
    ...
    def delete_product(self, product_id:int) -> HttpResponse:
        ...
        return HttpResponse(status_code=200, body={"message":"Product deleted successfully"})
