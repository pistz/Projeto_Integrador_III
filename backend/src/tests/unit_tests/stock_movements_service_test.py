...
from src.tests.mocks.mock_stock_movement_repository import get_mock_stock_movement_repository


class TestStockMovementService:

    @patch("src.infra.containers.service_container.ServiceContainer")
    def test_move_stock_success(self, mock_service_container):
        ...
        mock_current_stock_service.get_current_stock_by_product_id.return_value = SimpleNamespace(
        ...
        mock_service_container.current_stock_service.return_value = mock_current_stock_service
    ...
    def test_move_stock_invalid_data(self):
        repo = get_mock_stock_movement_repository()
        prod_repo = get_mock_product_repository()
    ...
    def test_get_single_stock_movement_success(self):
        repo = get_mock_stock_movement_repository()
        prod_repo = get_mock_product_repository()
    ...
    def test_get_single_stock_movement_not_found(self):
        repo = get_mock_stock_movement_repository()
        prod_repo = get_mock_product_repository()
    ...
    def test_get_stock_movement_by_date(self):
        repo = get_mock_stock_movement_repository()
        prod_repo = get_mock_product_repository()
    ...
    def test_get_stock_movement_by_date_range(self):
        repo = get_mock_stock_movement_repository()
        prod_repo = get_mock_product_repository()
