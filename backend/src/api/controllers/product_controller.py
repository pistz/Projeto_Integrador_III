...
class ProdutController:
    ...
    def get_product_by_id(self, product_id: int):
        response: HttpResponse = self.__product_service.get_product_by_id(
    ...
    def get_products_by_brand_id(self, brand_id: int):
        response: HttpResponse = self.__product_service.get_all_products_by_brand_id(
            brand_id=brand_id
        )
        return self.__send_response(response)

    def get_products_by_category_id(self, category_id: int):
        response: HttpResponse = self.__product_service.get_all_products_by_category_id(
    ...
    def create_product(self):
        ...
        response: HttpResponse = self.__product_service.create_product(
            create_product_dto
        )
        return self.__send_response(response)
    ...
    def delete_product(self, product_id: int):
        response: HttpResponse = self.__product_service.delete_product(
            product_id=product_id
        )
        return self.__send_response(response)
